...
# 注册接口
@main_bp.route("/python4nrl1242/forum/register", methods=['POST'])
def python4nrl1242_forum_register():
...
# 登录接口
@main_bp.route("/python4nrl1242/forum/login", methods=['GET','POST'])
def python4nrl1242_forum_login():
...
# 登出接口
@main_bp.route("/python4nrl1242/forum/logout", methods=['POST'])
def python4nrl1242_forum_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python4nrl1242/forum/resetPass", methods=['POST'])
def python4nrl1242_forum_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/python4nrl1242/forum/session", methods=['GET'])
def python4nrl1242_forum_session():
...
# 分类接口（后端）
@main_bp.route("/python4nrl1242/forum/page", methods=['GET'])
def python4nrl1242_forum_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/python4nrl1242/forum/autoSort", methods=['GET'])
def python4nrl1242_forum_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/python4nrl1242/forum/query", methods=['GET'])
def python4nrl1242_forum_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/python4nrl1242/forum/list", methods=['GET'])
def python4nrl1242_forum_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/python4nrl1242/forum/save", methods=['POST'])
def python4nrl1242_forum_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/python4nrl1242/forum/add", methods=['POST'])
def python4nrl1242_forum_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/python4nrl1242/forum/thumbsup/<id_>", methods=['GET'])
def python4nrl1242_forum_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/python4nrl1242/forum/info/<id_>", methods=['GET'])
def python4nrl1242_forum_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/python4nrl1242/forum/detail/<id_>", methods=['GET'])
def python4nrl1242_forum_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = forum.getbyid(forum, forum, int(id_))
...
# 更新接口
@main_bp.route("/python4nrl1242/forum/update", methods=['POST'])
def python4nrl1242_forum_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #如果存在密码或点击次数则不更新
...
# 删除接口
@main_bp.route("/python4nrl1242/forum/delete", methods=['POST'])
def python4nrl1242_forum_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/python4nrl1242/forum/vote/<int:id_>", methods=['POST'])
def python4nrl1242_forum_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= forum.getbyid(forum, forum, int(id_))
...
#查看所有开放的帖列表(无需登录)
@main_bp.route("/python4nrl1242/forum/flist", methods=['GET'])
def python4nrl1242_forum_flist():
...
@main_bp.route("/python4nrl1242/forum/list/<id_>", methods=['GET'])
def python4nrl1242_forum_list_id(id_):
    if request.method == 'GET':#get请求
...
#获取所有记录列表
@main_bp.route("/python4nrl1242/forum/lists", methods=['GET'])
def python4nrl1242_forum_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
