			...
			<el-form class="center-form-pv" :style='{"margin":"0 0px 20px 0","background":"none"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}' class="select" label="性别" prop="xingbie">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000000","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' class="item-label">性别</label>
