<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'"  label="意见反馈" prop="yijianfankui" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.yijianfankui" label="意见反馈" prop="yijianfankui" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.yijianfankui"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yijianfankui = this.ruleForm.yijianfankui.replace(reg,'../../../python4nrl1242/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
