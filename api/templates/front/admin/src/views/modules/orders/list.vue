			...
			<el-form class="center-form-pv" :style='{"margin":"0 0px 20px 0","background":"none"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#000000","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' class="item-label">订单编号</label>
				...
				<el-row class="actions" :style='{"padding":"10px 0","margin":"0px 0","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
						...
						<el-button class="btn18" type="success">
							<span class="icon iconfont icon-daochu17" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"34px"}'></span>
							导出
						</el-button>
					</download-excel>
					<el-button class="btn18" v-if="isAuth('orders'+'/'+orderStatus,'日销量')" type="success" @click="dayNumberChartDialog()">
						<span class="icon iconfont icon-xiaoliang2" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"34px"}'></span>
						日销量
					</el-button>
